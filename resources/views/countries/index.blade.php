        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
            ...
            <div class="row">
                <div class="col-lg-12 d-flex ">
                    ...
                    <div class="p-2">
                        <a class="btn btn-dark" href="{{ route('countries.create') }}" title="Create a Country">New</a>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-bordered table-responsive-lg">
                ...
                @foreach ($countries as $country)
                    <tr>
                        ...
                        <td>{{ $country->name }}</td>
                        <td>{{ date_format($country->created_at, 'jS M Y') }}</td>
                        <td>{{ date_format($country->updated_at, 'jS M Y') }}</td>
                        <td>
