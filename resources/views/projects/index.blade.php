                            ...
                            <form action="{{ route('projects.destroy', $project->id) }}" method="POST">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <a type="button" class="btn btn-outline-warning" href="{{ route('projects.edit', $project->id) }}" title="edit">
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" title="delete" class="btn btn-outline-danger" title="delete">
